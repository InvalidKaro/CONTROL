...
class WebUi {
 public:
  ...
  void begin(App** apps, int appCount, LedController* leds = nullptr,
             PowerManager* power = nullptr, ThemeManager* themes = nullptr,
  ...
  String ip() const;
  String webUser() const { return "admin"; }
  String webPassword() const { return webPassword_; }
 ...
 private:
  ...
  bool removeRecursive(fs::FS& fs, const String& path, uint8_t depth = 0);
